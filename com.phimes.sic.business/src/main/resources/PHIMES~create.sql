...
CREATE TABLE PRF_AREA_FILTRO
   ...
   -- ALTER TABLE PRF_AREA_FILTRO
   -- ADD CONSTRAINT PRF_AREA_FILTRO_PK PRIMARY KEY (ID_APPLICAZIONE, ID_AREA, ID_LIVELLO);
   
   CREATE INDEX PRF_AREA_FILTRO_APP_LIVELLO ON "PHIMES"."PRF_AREA_FILTRO" ("ID_APPLICAZIONE", "ID_LIVELLO");
...
ALTER TABLE PRF_MENU
   ...
   ALTER TABLE PRF_MENU ADD CONSTRAINT PRF_MENU_ORDINE_UK UNIQUE ("ORDINE");
    ...
    -- REFERENCES PRF_MENU(ID_MENU_PADRE);
