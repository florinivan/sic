...
import com.phimes.sic.business.service.RoleService;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// test Area
		AreaDto AreaDtotestArea = arSer.getAreaDto((long) 1, "app_code_test", "ar_code_test");
		Area areaTest = new Area();
		System.out.println(areaTest.getCode() + " " + areaTest.getDescription());
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		// test Filter
		List<FilterDto> listFilterDto;
		Filter flTest = new Filter();
		listFilterDto = flSer.getFilterListDto("ar_code_test", "lev_code_test");

		List<LevelDto> listLevelDto = new ArrayList();
		for (FilterDto x : listFilterDto) {
			System.out.println(x.getCode() + " " + x.getDescription() + " " + x.getLongDescription());
			listLevelDto.add(x.getLevel());
			for (LevelDto y : listLevelDto) {
				System.out.println(y.getCode() + " " + y.getDescription() + " " + y.getLevelOrder());
			}
		}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// test Function
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		// test Level
		LevelDto lvTest = lvSer.getLevelDto("app_code_test", "fil_code_test");
		Level levTest = new Level();
		levTest.getCode();

		System.out.println(levTest.getCode() + " " + levTest.getDescription() + " " + levTest.getLevel_Order());

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// test Menu
		List<MenuDto> listMenuDto;
		Menu menuTest = new Menu();
		listMenuDto = mnSer.getMenuDto("rl_code_test", "app_code_test", (long) 1);

		for (MenuDto x : listMenuDto) {
			System.out.println(x.getCode() + " " + x.getDescription() + " " + x.getUrl() + " " + " " + x.getMenuOrder()
					+ " " + " " + x.getIdSubMenu());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		listRoleDto = rlSer.getRoleListDto("app_code_test", "us_username_test", 'c');

		for (RoleDto x : listRoleDto) {
			System.out.println(x.getCode() + " " + x.getDescription());
		}
